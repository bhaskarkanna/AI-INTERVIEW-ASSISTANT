import { combineReducers, createStore } from "./redux-Cv3NUBxM.js";
	...
	return function(state, action) {
		...
		if (action.type === PERSIST) {
			...
			if (action.key === config.key) {
				...
				var _newState = _objectSpread$2({}, reconciledRest, { _persist: _objectSpread$2({}, _persist, { rehydrated: true }) });
